...
/*   Updated: 2024/09/25 17:25:34 by fcaldas-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "minishell.h"

static size_t	command_list_size(t_token_list *token_list)
{
	size_t	size;
	t_token_list	*tmp;
...
static char	*expand_single_quotes(char *arg)
{
	char	*quotes;
...
static char	*expand_double_quotes(char *arg)
{
	char	*quotes;
